...
// New creates a new id parameter API client.
func New(transport runtime.ClientTransport, formats strfmt.Registry) ClientService {
	return &Client{transport: transport, formats: formats}
}

/*
Client for id parameter API
*/
type Client struct {
...
/*
  GetID returns a single result based on the ID provided
*/
func (a *Client) GetID(params *GetIDParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*GetIDOK, error) {
	...
	msg := fmt.Sprintf("unexpected success response for getId: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
